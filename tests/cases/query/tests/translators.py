...
class TranslatorTestCase(BaseTestCase):
    ...
    def test_char_in(self):
        trans = self.first_name.translate(value=['Robert', None], operator='in', tree=Employee)
    ...
    def test_decimal(self):
        ...
        self.assertEqual(unicode(trans['query_modifiers']['condition']), "(AND: ('budget__exact', Decimal('50')))")

    def test_decimal_long(self):
        self.assertRaises(ValidationError, self.budget.translate, value=50.3932, tree=Project)
