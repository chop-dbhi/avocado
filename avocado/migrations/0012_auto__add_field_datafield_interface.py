...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataField.interface'
        db.add_column('avocado_datafield', 'interface',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataField.interface'
        db.delete_column('avocado_datafield', 'interface')
    ...
    models = {
        ...
        'avocado.datafield': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interface': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'internal': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'keywords': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
