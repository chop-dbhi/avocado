...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('avocado_category', 'order', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Category.order'
        db.delete_column('avocado_category', 'order')
    ...
    models = {
        ...
        'avocado.perspective': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 3, 17, 21, 31, 401347)'}),
