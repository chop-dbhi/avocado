...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        views = orm['avocado.DataView'].objects.filter(json__icontains='"concepts"')
        for view in views:
            json = view.json
            json['columns'] = json['concepts']
            del json['concepts']
            view.json = json
            view.save()
    ...
    def backwards(self, orm):
        ...
        views = orm['avocado.DataView'].objects.filter(json__icontains='"columns"')
        for view in views:
            json = view.json
            json['concepts'] = json['columns']
            del json['columns']
            view.json = json
            view.save()
