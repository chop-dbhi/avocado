...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field shared_users on 'DataQuery'
        m2m_table_name = db.shorten_name('avocado_dataquery_shared_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dataquery', models.ForeignKey(orm['avocado.dataquery'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['dataquery_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field shared_users on 'DataQuery'
        db.delete_table(db.shorten_name('avocado_dataquery_shared_users'))
    ...
    models = {
        ...
        'avocado.datacontext': {
            ...
            'accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 26, 0, 0)'}),
            'archived': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
