...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('avocado_revision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('data', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+revision', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('avocado', ['Revision'])


    def backwards(self, orm):
        # Deleting model 'Revision'
        db.delete_table('avocado_revision')
    ...
    models = {
        ...
        'avocado.datacontext': {
            ...
            'accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 30, 0, 0)'}),
            'archived': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
