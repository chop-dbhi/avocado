...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Revision.changes'
        db.add_column('avocado_revision', 'changes',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Revision.changes'
        db.delete_column('avocado_revision', 'changes')
    ...
    models = {
        ...
        'avocado.datacontext': {
            ...
            'accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 27, 0, 0)'}),
            'archived': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
