...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DataField.searchable'
        db.delete_column('avocado_datafield', 'searchable')


    def backwards(self, orm):
        # Adding field 'DataField.searchable'
        db.add_column('avocado_datafield', 'searchable',
