...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Perspective.timestamp'
        db.alter_column('avocado_perspective', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Adding field 'Report.count'
        db.add_column('avocado_report', 'count', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='cnt'), keep_default=False)

        # Changing field 'Scope.timestamp'
        db.alter_column('avocado_scope', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))


    def backwards(self, orm):
        
        # Changing field 'Perspective.timestamp'
        db.alter_column('avocado_perspective', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

        # Deleting field 'Report.count'
        db.delete_column('avocado_report', 'cnt')

        # Changing field 'Scope.timestamp'
        db.alter_column('avocado_scope', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
