...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'DataConcept.formatter'
        db.rename_column('avocado_dataconcept', 'formatter', 'formatter_name')


    def backwards(self, orm):
        # Renaming field 'DataConcept.formatter_name'
        db.rename_column('avocado_dataconcept', 'formatter_name', 'formatter')
