...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataView.name'
        db.alter_column('avocado_dataview', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'DataField.name'
        db.alter_column('avocado_datafield', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'DataCategory.name'
        db.alter_column('avocado_datacategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'DataContext.name'
        db.alter_column('avocado_datacontext', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'DataConcept.name'
        db.alter_column('avocado_dataconcept', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'DataView.name'
        db.alter_column('avocado_dataview', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DataField.name'
        db.alter_column('avocado_datafield', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DataCategory.name'
        db.alter_column('avocado_datacategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DataContext.name'
        db.alter_column('avocado_datacontext', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DataConcept.name'
        db.alter_column('avocado_dataconcept', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
