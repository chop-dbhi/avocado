...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataConcept.type'
        db.add_column(u'avocado_dataconcept', 'type',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataConcept.type'
        db.delete_column(u'avocado_dataconcept', 'type')
    ...
    models = {
        ...
        u'avocado.datacontext': {
            ...
            'accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 2, 0, 0)'}),
