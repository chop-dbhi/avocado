...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataView.parent'
        db.add_column(u'avocado_dataview', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forks', null=True, to=orm['avocado.DataView']),
                      keep_default=False)

        # Adding field 'DataQuery.parent'
        db.add_column(u'avocado_dataquery', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forks', null=True, to=orm['avocado.DataQuery']),
                      keep_default=False)

        # Adding field 'DataContext.parent'
        db.add_column(u'avocado_datacontext', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forks', null=True, to=orm['avocado.DataContext']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataView.parent'
        db.delete_column(u'avocado_dataview', 'parent_id')

        # Deleting field 'DataQuery.parent'
        db.delete_column(u'avocado_dataquery', 'parent_id')

        # Deleting field 'DataContext.parent'
        db.delete_column(u'avocado_datacontext', 'parent_id')
    ...
    models = {
        ...
        u'avocado.datacontext': {
            ...
            'accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
