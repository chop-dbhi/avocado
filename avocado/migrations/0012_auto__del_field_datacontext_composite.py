...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DataContext.composite'
        db.delete_column('avocado_datacontext', 'composite')


    def backwards(self, orm):
        # Adding field 'DataContext.composite'
        db.add_column('avocado_datacontext', 'composite',
