...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'avocado_dataquery', 'record_count')

        # Deleting field 'DataQuery.distinct_count'
        db.delete_column(u'avocado_dataquery', 'distinct_count')

        # Deleting field 'DataQuery.tree'
        db.delete_column(u'avocado_dataquery', 'tree')

        # Deleting field 'DataContext.count'
        db.delete_column(u'avocado_datacontext', '_count')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'avocado_dataquery', 'record_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'DataQuery.distinct_count'
        db.add_column(u'avocado_dataquery', 'distinct_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)
        ...
        # Adding field 'DataContext.count'
        db.add_column(u'avocado_datacontext', 'count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_column='_count'),
                      keep_default=False)
