...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataField.engine'
        db.add_column(u'avocado_datafield', 'engine',
                      self.gf('django.db.models.fields.CharField')(default='avocado.engines._django', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataField.engine'
        db.delete_column(u'avocado_datafield', 'engine')
    ...
    models = {
        ...
        u'avocado.datacontext': {
            ...
            'accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 2, 0, 0)'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'avocado.datafield': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'engine': ('django.db.models.fields.CharField', [], {'default': "'avocado.engines._django'", 'max_length': '200'}),
