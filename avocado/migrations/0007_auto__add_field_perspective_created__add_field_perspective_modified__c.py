...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('avocado_perspective', 'store', self.gf('avocado.store.fields.PickledField')(editable=False))
        ...
        db.alter_column('avocado_scope', 'store', self.gf('avocado.store.fields.PickledField')(editable=False))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Perspective.store'
        db.alter_column('avocado_perspective', 'store', self.gf('avocado.store.fields.PickledField')(null=True, editable=False))
        ...
        # Changing field 'Scope.store'
        db.alter_column('avocado_scope', 'store', self.gf('avocado.store.fields.PickledField')(null=True, editable=False))
    ...
    models = {
        ...
        'avocado.perspective': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'store': ('avocado.store.fields.PickledField', [], {'editable': 'False'}),
