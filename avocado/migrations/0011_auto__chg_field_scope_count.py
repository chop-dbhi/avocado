...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scope.count'
        db.alter_column('avocado_scope', 'cnt', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='cnt'))


    def backwards(self, orm):
        
        # Changing field 'Scope.count'
        db.alter_column('avocado_scope', 'cnt', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, db_column='cnt'))
