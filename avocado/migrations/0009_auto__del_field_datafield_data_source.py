...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DataField.data_source'
        db.delete_column('avocado_datafield', 'data_source')


    def backwards(self, orm):
        # Adding field 'DataField.data_source'
        db.add_column('avocado_datafield', 'data_source',
