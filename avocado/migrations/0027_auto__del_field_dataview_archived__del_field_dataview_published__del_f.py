...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'avocado_dataview', 'archived')

        # Deleting field 'DataView.published'
        db.delete_column(u'avocado_dataview', 'published')

        # Deleting field 'DataQuery.archived'
        db.delete_column(u'avocado_dataquery', 'archived')

        # Deleting field 'DataQuery.published'
        db.delete_column(u'avocado_dataquery', 'published')

        # Deleting field 'DataContext.archived'
        db.delete_column(u'avocado_datacontext', 'archived')

        # Deleting field 'DataContext.published'
        db.delete_column(u'avocado_datacontext', 'published')


    def backwards(self, orm):
        # Adding field 'DataView.archived'
        db.add_column(u'avocado_dataview', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataView.published'
        db.add_column(u'avocado_dataview', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataQuery.archived'
        db.add_column(u'avocado_dataquery', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataQuery.published'
        db.add_column(u'avocado_dataquery', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataContext.archived'
        db.add_column(u'avocado_datacontext', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataContext.published'
        db.add_column(u'avocado_datacontext', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
