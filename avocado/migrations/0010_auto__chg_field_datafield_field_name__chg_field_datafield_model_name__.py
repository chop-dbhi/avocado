...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataField.field_name'
        db.alter_column('avocado_datafield', 'field_name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'DataField.model_name'
        db.alter_column('avocado_datafield', 'model_name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'DataField.name_plural'
        db.alter_column('avocado_datafield', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'DataField.app_name'
        db.alter_column('avocado_datafield', 'app_name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'DataConcept.name_plural'
        db.alter_column('avocado_dataconcept', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'DataField.field_name'
        db.alter_column('avocado_datafield', 'field_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'DataField.model_name'
        db.alter_column('avocado_datafield', 'model_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'DataField.name_plural'
        db.alter_column('avocado_datafield', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'DataField.app_name'
        db.alter_column('avocado_datafield', 'app_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'DataConcept.name_plural'
        db.alter_column('avocado_dataconcept', 'name_plural', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
