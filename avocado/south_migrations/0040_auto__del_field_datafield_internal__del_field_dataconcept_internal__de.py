...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DataField.internal'
        db.delete_column(u'avocado_datafield', 'internal')

        # Deleting field 'DataConcept.internal'
        db.delete_column(u'avocado_dataconcept', 'internal')

        # Deleting field 'DataConcept.ident'
        db.delete_column(u'avocado_dataconcept', 'ident')


    def backwards(self, orm):
        # Adding field 'DataField.internal'
        db.add_column(u'avocado_datafield', 'internal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataConcept.internal'
        db.add_column(u'avocado_dataconcept', 'internal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DataConcept.ident'
        db.add_column(u'avocado_dataconcept', 'ident',
    ...
    models = {
        ...
        u'avocado.datacontext': {
            ...
            'accessed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 22, 0, 0)'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
