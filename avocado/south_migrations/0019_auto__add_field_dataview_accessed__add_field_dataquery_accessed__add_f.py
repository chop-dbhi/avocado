...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataQuery.accessed'
        db.add_column('avocado_dataquery', 'accessed',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'DataContext.accessed'
        db.add_column('avocado_datacontext', 'accessed',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataView.accessed'
        db.delete_column('avocado_dataview', 'accessed')

        # Deleting field 'DataQuery.accessed'
        db.delete_column('avocado_dataquery', 'accessed')

        # Deleting field 'DataContext.accessed'
        db.delete_column('avocado_datacontext', 'accessed')
