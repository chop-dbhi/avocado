...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DataField.group'
        db.delete_column(u'avocado_datafield', 'group_id')

        # Deleting field 'DataConcept.group'
        db.delete_column(u'avocado_dataconcept', 'group_id')


    def backwards(self, orm):
        # Adding field 'DataField.group'
        db.add_column(u'avocado_datafield', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='fields+', null=True, to=orm['auth.Group'], blank=True),
                      keep_default=False)

        # Adding field 'DataConcept.group'
        db.add_column(u'avocado_dataconcept', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='concepts+', null=True, to=orm['auth.Group'], blank=True),
                      keep_default=False)
