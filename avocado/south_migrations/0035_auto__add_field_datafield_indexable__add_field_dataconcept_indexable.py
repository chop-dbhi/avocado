...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataField.indexable'
        db.add_column(u'avocado_datafield', 'indexable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DataConcept.indexable'
        db.add_column(u'avocado_dataconcept', 'indexable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataField.indexable'
        db.delete_column(u'avocado_datafield', 'indexable')

        # Deleting field 'DataConcept.indexable'
        db.delete_column(u'avocado_dataconcept', 'indexable')
