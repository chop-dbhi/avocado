...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataConcept.viewable'
        db.add_column('avocado_dataconcept', 'viewable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataConcept.viewable'
        db.delete_column('avocado_dataconcept', 'viewable')
